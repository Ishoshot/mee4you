...
<html>
<head>
<title>Official SendMe Website - Contact</title>
<!--/tags -->
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  	<ul class="nav navbar-nav menu__list">
						...
						<li class="active menu__item">
							<a class="menu__link" href="index.php#foodcatalogue">Food Order <span class="badge new">new</span></a>
						</li>
		...
		<div class="contact-grid-agile-w3s">
			...
			<div class="col-md-4 contact-grid-agile-w3">
				<div class="contact-grid-agile-w31">
					...
					<h4>Address</h4>
					<p>
						God First Complex Isolo Egbe Road, Jakande Bus stop, Oshodi-Isolo, Lagos.
					</p>
				</div>
			</div>
			...
			<div class="col-md-4 contact-grid-agile-w3">
				<div class="contact-grid-agile-w32">
					...
					<h4>Call Us</h4>
					<p>+234 811 806 0583<span>+234 816 631 5790</span></p>
				</div>
			</div>
			...
			<div class="col-md-4 contact-grid-agile-w3">
				<div class="contact-grid-agile-w33">
					...
					<p>
						<a href="mailto:sendmee4u@gmail.com">sendmee4u@gmail.com</a>
						<span><a href="mailto:sendmee4u@outlook.com">sendmee4u@outlook.com</a></span>
					</p>
				</div>
			</div>
...
<!--Contact Informtion Ends here  -->

<div class="contact-w3-agile1" data-aos="flip-right">
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d990.9836857561838!2d3.3083231002092353!3d6.529926404216988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8ffc56645d9d%3A0x1acc69d98cd65189!2sGod+First+Shopping+Complex!5e0!3m2!1sen!2sng!4v1559389548112!5m2!1sen!2sng" frameborder="0" style="border:0" allowfullscreen=""></iframe>
</div>
			...
			<div class="agile-contact-left">
				<div class="col-md-6 address-grid">
					<h4>For More <span>Information</span></h4>
						...
						<div class="mail-agileits-w3layouts">
							...
							<div class="contact-right">
								<p>Telephone </p><span>+234 811 806 0583</span>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="mail-agileits-w3layouts">
							<i class="fa fa-envelope-o" aria-hidden="true"></i>
							<div class="contact-right">
								<p>Mail </p><a href="mailto:sendmee4u@gmail.com">sendmee4u@gmail.com</a>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="mail-agileits-w3layouts">
							<i class="fa fa-map-marker" aria-hidden="true"></i>
							<div class="contact-right">
								<p>Location</p><span>God First Complex Isolo Egbe Road, <br/> Jakande Bus stop, Oshodi-Isolo, Lagos.</span>
							</div>
							<div class="clearfix"> </div>
						</div>
					...
					<div class="col-md-6 contact-form">
						...
						<form action="https://formspree.io/sendmee4u@gmail.com" method="POST">

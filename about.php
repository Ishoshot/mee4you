...
<html>
<head>
<title>Official SendMe Website - About</title>
<!--/tags -->
...
<div class="page-head_agile_info_w3l page-head_agile_info_w3l2">
	<div class="container">
		<h3>A<span>bout Us </span></h3>
		<!--/w3_short-->
	    ...
	    <div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-4 ab_pic_w3ls">
				   	<img src="images/newabout.jpg" alt="" style="height:300px;" class="img-responsive" />
				</div>
				 <div class="col-md-8 ab_pic_w3ls_text_info">
				    <h5>About Send Me </h5>
					<p>Send Me is a company that renders household chores services, errand services and food order and delivery services.</p>
					<p>Our service(s) is fast and prompt, reliable, and affordable. We also provide service provider-to-customer relationship. Our Service(s) is open 24/7 as we will be open and happy to attend to you..</p>
				</div>
				  <div class="clearfix"></div>
			</div>    
		 </div> 
		...
		<div class="inner_w3l_agile_grids">
			<div class="col-md-3">
				<div class="thumbnail team-w3agile">
					<img src="images/jonathan.jpg" class="img-responsive" alt="">
					<div class="social-icons team-icons right-w3l fotw33">
						<div class="caption">
							<h4>Jonathan Aderoju</h4>
	        ...
	        <div class="col-md-3">
				<div class="thumbnail team-w3agile">
					<img src="images/ronny.jpg" class="img-responsive" alt="">
					<div class="social-icons team-icons right-w3l fotw33">
						<div class="caption">
							<h4>Omoronke Olubokun</h4>
	        ...
	        <div class="col-md-3">
				<div class="thumbnail team-w3agile">
					...
					<div class="social-icons team-icons right-w3l fotw33">
						<div class="caption">
							<h4>Oluwatobi Ishola</h4>
							<p>Developer | Strategist</p>						
						</div>
						<ul class="social-nav model-3d-0 footer-social w3_agile_social two">
							<li><a href="#" class="facebook">
								  <div class="front"><i class="fa fa-facebook" aria-hidden="true"></i></div>
